# -*- coding: utf-8 -*-
"""upload Session_5_RAG_Streamlit.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1oSn6IoEBHSt-GyZrQA8gp6xCnH1KMti4
...
streamlit run rag_streamlit.py --server.port=5000 &>./logs.txt &
